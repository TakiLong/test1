...
public class FileUtil {  
    ...
    public FileUtil(String filename) throws Exception {  
    ...
    /** 
     *把文件的一行转换成字符串数组。指定数组长度，不够长度的部分设置为null。 
     */  
    @SuppressWarnings({ "rawtypes", "unchecked" })
	public static String[] fromFileLine(String source, int size) {  
        ArrayList tmpArray = fromFileLinetoArray(source);  
     ...
     */  
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public static ArrayList fromFileLinetoArray(String source) {  
    ...
    /** 
     * 把字符串类型的数组转换成一行。（输出文件的时候用） 
     */  
    public static String toFileLine(String[] strArray) {  
        if (strArray == null) {  
            return "";  
        }  
    ...
    /** 
     * 字符串类型的List转换成一行。（输出文件的时候用） 
     */ 
    @SuppressWarnings( "rawtypes" )
    public static String toFileLine(ArrayList strArrList) {  
        if (strArrList == null) {  
            return "";  
        }  
